    ...
    <DashboardLayout>
      <div className="space-y-6 animate-fade-in">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Customer Users</h1>
            <p className="text-gray-600">Manage all customer accounts and their orders</p>
          </div>
        ...
        <UsersStats users={customerUsers} isLoading={usersLoading} />
